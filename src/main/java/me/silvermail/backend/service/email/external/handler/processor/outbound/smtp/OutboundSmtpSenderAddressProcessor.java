...
public class OutboundSmtpSenderAddressProcessor extends AbstractOutboundProcessor {
    public void process(ExternalEmail externalEmail, ContactAlias recipientContactAlias) {
        externalEmail.getSmtpSenderAddress().setAddress(recipientContactAlias.getMailboxAlias().getValue());
    }
}
